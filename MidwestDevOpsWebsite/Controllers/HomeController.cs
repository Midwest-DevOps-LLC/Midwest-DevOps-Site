        ...
        public IActionResult ContactUs(ContactUsModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (validationModel.validationStatus == Models.ValidationStatus.Success)
                {
                    ...
                    MDO.EmailHandler.Standard.EmailHandler.SendEmail(MDO.EmailHandler.Standard.EmailHandler.EmailAddresses.alerts, "webmaster@mail.midwestdevops.com", "mpbhhkpodykjutef", subject, body, true);
                }
            }
